...
def main():
    ...
    for i in range(1, page + 1):
        ...
        for item in result['sku']:
            ...
            if denomination and float(price) - float(denomination) > 0 and code:
                ...
                print('商品价格：', price)
                print('优惠券金额：', denomination)
                print('商品券后价格：', float(price) - float(denomination))
                print('商品分享链接：', code)
                print('-' * 50)
                print()
                filename = '/Users/CEO/Desktop/images/' + str(skuId) + '.jpg'
            ...
            #for chatroom in chatrooms:
                ...
                #NickName = chatroom['NickName']
                    ...
                    #if NickName == 'JD京东官方特惠':
            name = itchat.search_chatrooms(name='JD京东官方特惠')
